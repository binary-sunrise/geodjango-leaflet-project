...
Db = Pg(dbname='geoApp', user='postgres', password='postgres', host='localhost', port='5432')
...
def publish_data(sender,instance,created,**kwargs):
    ...
    geo.create_featurestore(store_name='geoapp_store', workspace='geoapp', db='geoApp', host='localhost',
                             pg_user='postgres',pg_password='postgres',schema ='data')
    geo.publish_featurestore(workspace='geoapp', store_name='geoapp_store', pg_table=name)
...
def delete_data(sender,instance,**kwargs):
    ...
    geo.delete_layer(instance.name,workspace='geoapp')